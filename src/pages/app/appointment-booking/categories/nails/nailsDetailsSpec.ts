...
export const nailTypeRows: NailTypeRowItem[][] = [
  [
    { label: 'Stilleto', variant: 'stiletto', imageSrc: nailsBookingAssets.nailTypes.stiletto, className: 'h-[64px] w-full min-w-0' },
    { label: 'Coffin', variant: 'coffin', imageSrc: nailsBookingAssets.nailTypes.coffin, className: 'h-[64px] w-full min-w-0' },
  ],
  [
    { label: 'Almond', variant: 'almond', imageSrc: nailsBookingAssets.nailTypes.almond, className: 'h-[64px] w-full min-w-0' },
    { label: 'Oval', variant: 'oval', imageSrc: nailsBookingAssets.nailTypes.oval, className: 'h-[64px] w-full min-w-0' },
  ],
  [
    { label: 'Squoval', variant: 'squoval', imageSrc: nailsBookingAssets.nailTypes.squoval, className: 'h-[64px] w-full min-w-0' },
    { label: 'Square', variant: 'square', imageSrc: nailsBookingAssets.nailTypes.square, className: 'h-[64px] w-full min-w-0' },
  ],
  [
    { label: 'Round', variant: 'round', imageSrc: nailsBookingAssets.nailTypes.round, className: 'h-[64px] w-full min-w-0' },
    { label: 'Custom', variant: 'custom', imageSrc: nailsBookingAssets.nailTypes.custom, className: 'h-[64px] w-full min-w-0' },
  ],
]
