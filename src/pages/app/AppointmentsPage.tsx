...
export function AppointmentsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <PageTitle action={<Button onClick={() => navigate('/app/appointments/new?fresh=1')} size="icon"><CalendarPlus className="size-5" /></Button>} title="Appointments" subtitle="Review today's schedule and manage appointment status." />
