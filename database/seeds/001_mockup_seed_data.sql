...
INSERT INTO services
  (id, salon_id, category_id, form_template_id, name, slug, description, duration_minutes, price_minor, sort_order)
VALUES
  ('60000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000002', 'Full Set - Acrylic', 'full-set-acrylic', 'Acrylic full set with shape and finish selection.', 90, 8500, 10),
  ('60000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000002', 'Full Set - Gel', 'full-set-gel', 'Gel full set with custom nail details.', 75, 8500, 20),
  ('60000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000002', 'Nail Fill', 'nail-fill', 'Maintenance fill for acrylic or gel nails.', 60, 6500, 30),
  ('60000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '90000000-0000-0000-0000-000000000003', 'Cat Eye - Classic', 'cat-eye-classic', 'Classic cat-eye lash set.', 90, 12000, 10),
  ('60000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '90000000-0000-0000-0000-000000000003', 'Lash Fill', 'lash-fill', 'Maintenance lash fill.', 60, 7500, 20),
  ('60000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000003', '90000000-0000-0000-0000-000000000004', 'Cosmetology - Dermapen', 'cosmetology-dermapen', 'Microneedling facial treatment with professional equipment.', 60, 9500, 10),
  ('60000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000003', '90000000-0000-0000-0000-000000000004', 'Chemical Peel', 'chemical-peel', 'Professional facial chemical peel.', 60, 9000, 20),
  ('60000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000005', 'Micropigmentation - microblading', 'micropigmentation-microblading', 'Eyebrow microblading treatment.', 90, 10500, 10),
  ('60000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000005', 'Micropigmentation - Lip Liner', 'micropigmentation-lip-liner', 'Semi-permanent lip liner treatment.', 60, 7500, 20),
  ('60000000-0000-0000-0000-000000000010', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000005', 'Micropigmentation - Microshading', 'micropigmentation-microshading', 'Eyebrow microshading treatment.', 90, 11000, 30),
  ('60000000-0000-0000-0000-000000000011', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000005', 'Micropigmentation - Hybrid', 'micropigmentation-hybrid', 'Hybrid eyebrow micropigmentation treatment.', 90, 11000, 40),
  ('60000000-0000-0000-0000-000000000012', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000005', 'Micropigmentation - Removal', 'micropigmentation-removal', 'Pigment removal treatment.', 60, 8500, 50),
  ('60000000-0000-0000-0000-000000000013', '10000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000005', 'Micropigmentation - Eyeliner', 'micropigmentation-eyeliner', 'Permanent eyeliner treatment.', 60, 3500, 60);
...
INSERT INTO professional_services (professional_id, salon_id, service_id) VALUES
  ...
  ('30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000010'),
  ('30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000011'),
  ('30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000012'),
  ('30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000013'),
...
BEGIN
  ...
  IF (SELECT count(*) FROM services WHERE salon_id = '10000000-0000-0000-0000-000000000001') <> 13 THEN
    RAISE EXCEPTION 'Expected thirteen Glow Salon services';
  END IF;
  ...
  IF (SELECT count(*) FROM public_booking_catalog WHERE salon_slug = 'glow-salon') <> 13 THEN
    RAISE EXCEPTION 'Expected thirteen publicly bookable catalog services';
  END IF;
END;
$$;
